...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/dashboard', "App\Http\Controllers\PointController@getExchangePage")->name("dashboard");
    
    // Cashier routes
    Route::middleware(['role:cashier'])->group(function () {
        Route::get('/exchange', "App\Http\Controllers\PointController@getExchangePage")->name("exchange")->middleware("role:cashier");
        Route::get('/points/list', "App\Http\Controllers\PointController@pointsLoginList")->name("points")->middleware("role:cashier");
